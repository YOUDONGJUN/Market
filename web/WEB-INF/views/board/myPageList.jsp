...
<div class="container">
    ...
    <section>
        ...
        <div class="mypage">
            <div class="tab">
                <ul>
                    <li class="clicked"><a href="../board/myPageList.jsp?id=${loginUser }">판매 게시판</a></li>
                    <li><a href="../board/qnaMyPageList.jsp?id=${loginUser }">문의 게시판</a></li>
                </ul>
            </div>
                ...
                <table class="table-style">
                    ...
                    <c:forEach var="dto" items="${mypageList }">
                        <tr>
                            ...
                            <td>
                                <a href="${contextPath }/board/contentView.jsp?product_no=${dto.product_no}">${dto.product_title }</a>
                            </td>
                            <td>${dto.product_writer }</td>
                            <td>
                                <fmt:parseDate value="${dto.product_day}" var="product_day"
                    ...
                    <tr>
                        <td colspan="4" align="center">
                            <c:forEach var="num" begin="1" end="${repeat }">
                                <a href="../myPageList.jsp?num=${num }&id=${loginUser}">[ ${num } ]</a>
                            </c:forEach>
                        </td>
                    </tr>
                </table>

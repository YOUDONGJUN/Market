...
<body>
    <div class="container">
        ...
        <section>
            ...
            <div class="tab">
	         	<ul>
	         		<li class="clicked"><a href="/root/board/mypageList?id=${loginUser }">판매 게시판</a></li>
	         		<li><a href="/root/board/qnamypageList?id=${loginUser }">문의 게시판</a></li>
	         	</ul>
       		</div>
			<div class="mypage-con">
				<table class="table-style">
					...
					<tr>				
						...
						<td><a href="${contextPath }/board/contentView?product_no=${dto.product_no}">${dto.product_title }</a></td>
					...
					<tr>
						<td colspan="4" align="center">
							<c:forEach var="num" begin="1" end="${repeat }">
								<a href="mypageList?num=${num }&id=${loginUser}">[ ${num } ]</a>
							</c:forEach>
						</td>
					</tr>	
				</table>
